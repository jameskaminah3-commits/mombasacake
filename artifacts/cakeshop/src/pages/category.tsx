...
const CATEGORY_NAV = [
  { key: "kitchen",     label: "Kitchen & Lifestyle", href: "/category/kitchen" },
  { key: "appliances",  label: "Appliances",          href: "/category/appliances" },
  { key: "fitness",     label: "Fitness",             href: "/category/fitness" },
...
export default function CategoryPage() {
  ...
  const heroKey = SLUG_TO_HERO[slug.toLowerCase()] ?? "kitchen";
  const hero    = CATEGORY_HEROES[heroKey];
  ...
  // Auto-match slug to API category on page load / slug change
  useEffect(() => {
  ...
  return (
    <div className="bg-background min-h-screen">
      ...
      {/* Hero — full width, title at bottom-left */}
      <div className="w-full flex items-end" style={{ backgroundColor: hero.bg, minHeight: "320px" }}>
      ...
      <div className="bg-white border-b border-border">
        <div className="container mx-auto px-4 h-11 flex items-center gap-0 overflow-x-auto">
          <Link
            href="/menu"
            className="text-xs font-semibold px-4 h-11 flex items-center whitespace-nowrap border-b-2 border-transparent text-muted-foreground hover:text-foreground transition-colors"
          >
            All
          </Link>
      ...
      <div className="container mx-auto px-4 py-10">
        ...
        <div className="flex gap-8 items-start">
          ...
          <main className="flex-1 min-w-0">
            ...
            {/* Subcategory tiles */}
            {CATEGORY_SUBCATEGORIES[heroKey] && (
            ...
            {loadingCakes ? (
              ...
              <>
                ...
                <p className="mt-10 text-center text-sm text-muted-foreground">
                  ...
                  {selectedCatName ? ` in ${selectedCatName}` : ` in ${hero.title}`}
                </p>
              </>
            )}
          </main>
